                ...
                else
                {
                    ...
                    mAuth.sendPasswordResetEmail(u).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            if(task.isSuccessful())
                            {
                                Toast.makeText(MainActivity.this,"Reset mail sent successfully to your account",Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                Toast.makeText(MainActivity.this,"Failed to send reset mailto your account",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
